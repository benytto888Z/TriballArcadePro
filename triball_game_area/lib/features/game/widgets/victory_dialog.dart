...
class VictoryDialog extends GetView<GameController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (!controller.isVictory || !controller.showVictoryDialog.value) {
      ...
      final color = Helpers.playerColor(
        controller.players.indexOf(winner),
      );
      ...
      final dialogWidth = screenWidth > 1200
          ? screenWidth * 0.45    // TV : 45%
          : screenWidth > 900
          ? screenWidth * 0.55  // Tablet : 55%
                  ...
                  child: ConstrainedBox(
                    ...
                    //  width: GameScreenBreakpoints.victoryDialogWidth(),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('🏆', style: TextStyle(fontSize: GameScreenBreakpoints.victoryTrophySize())),
                          SizedBox(height: 3.h),
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              fontSize: GameScreenBreakpoints.victoryTitleFontSize(),
                          ...
                          // Winner name
                          Text(
                            controller.winnerNamesFormatted.toUpperCase(),
                            style: TextStyle(
                              fontFamily: GameConstants.gameFontFamily,
                              fontSize: GameScreenBreakpoints.victoryNameFontSize(),
                         ...
                         /*Row(
                          ...
                          Obx(() {
                            final countdown = controller.returnToWaitingCountdown.value;
