      ...
      return Column(
        ...
        children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontFamily: 'Orbitron',
                          fontSize: GameScreenBreakpoints.waitingWinnerNameFontSize(),
          ...
          Text(
            ...
            style: TextStyle(
              fontFamily: 'Orbitron',
              fontSize: GameScreenBreakpoints.waitingDetailFontSize(),
              color: ThemeColors.textSecondary,
              height: 1.6,
              letterSpacing: 1,
            ),
        ...
        return Text(
          ...
          style: TextStyle(
            ...
            shadows: ThemeColors.useGlow
                ? [
              Shadow(
                color: widget.color.withOpacity(_opacity.value * 0.8),
                blurRadius: 12,
              ),
            ]
                : null,
