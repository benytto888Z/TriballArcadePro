...
// Guide
  ...
  'top_10': 'TOP 10 !',
  'not_in_top_10': 'Ooh, pas dans le TOP 10 !',
  'rank': 'Rang {position}',
  'play_again': 'Rejouer',
  'back_to_menu': 'Menu',
  ...
  'tournament_eight': '8ème de finale',
  ...
  'tts_not_in_top_10': 'Ooh, pas dans le top 10 !',
...
// Platform
  ...
  'guide_platform_setup_bullet_2': 'Branche le ESP32 sur secteur',
...
// About
  ...
  'waiting_for_config': 'En attente d\'une configuration...',
  'config_received': 'Configuration reçue',
  'no_config_area_connected': 'Aucune tablette de configuration connectée',
  'config_area_count': 'Tablettes connectées : {count}',

  'declaring_role': 'Déclaration du rôle...',
  'config_area_label': 'Tablette config',
  'waiting_instruction_detail': 'Configurez votre partie\ndepuis la tablette',
  'last_winner': 'Dernier gagnant',

  'back_to_waiting': 'Écran d\'attente',
  'auto_return_in': 'Retour dans',

  'clear_requires_code': 'Entrez le code de sécurité pour effacer le classement',
  'clear_mode_warning': 'Cette action effacera le TOP 10 du mode {mode}.',
  'invalid_security_code': 'Code de sécurité incorrect',
  'leaderboard_cleared': 'Classement effacé avec succès',
  ...
  'admin_options': 'Options administrateur',
