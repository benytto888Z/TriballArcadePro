...
const Map<String, String> deDE = {
  ...
  'check_esp32': 'Prüfe, ob der Plattform eingeschaltet ist',
  ...
  'guide_platform_setup_bullet_2': 'Plattform einstecken',
  ...
  'no_game_area_connected': 'Kein Spielbildschirm verbunden',
  'config_sent_to_game_area': 'Konfiguration an Spielbildschirm gesendet',
  'game_area_count': 'Verbundene Bildschirme: {count}',
  'waiting_for_game_area': 'Warte auf Spielbildschirm...',

  'game_area_label': 'Spielbildschirm',
  'checking_game_area': 'Spielbildschirm suchen...',
  'waiting_for_game_area_short': 'Warten...',
  'utilities': 'Werkzeuge',
  'config_area_subtitle': 'Spielkonfigurator',

  'send_to_screen': 'An Bildschirm senden',
  'sending': 'Wird gesendet...',
  'send_another': 'Weitere senden',
  'config_sent_title': 'Konfiguration gesendet!',
  'config_sent_message': 'Das Spiel startet auf dem Spielbildschirm.',
  'config_send_failed': 'Senden fehlgeschlagen. Verbindung prüfen.',
  'no_game_area_title': 'Bildschirm nicht verbunden',
  'no_game_area_message': 'Kein Spielbildschirm (TV) verbunden.\n\nPrüfen:\n• Windows-Bildschirm eingeschaltet\n• Verbunden mit WiFi "amz_triball"\n• Game Area App geöffnet',
  'no_game_area_warning': 'Kein Spielbildschirm verbunden. TV verbinden vor dem Senden.',

  'game_area_settings': 'Spielbildschirm',
  'game_area_connected_count': 'Verbundene Bildschirme',
  'game_area_state': 'Spielstatus',
  'current_player_label': 'Aktueller Spieler',
  'last_config_sent': 'Letzte gesendete Config',
  'none': 'Keine',
  'stop_game_remote_btn': 'Spiel stoppen',
  'state_waiting': 'Warten',
  'state_countdown': 'Countdown',
  'state_playing': 'Läuft',
  'state_victory': 'Sieg',
  'state_game_over': 'Beendet',

  'guide_gc_setup_title': 'Game Center Installation',
  'guide_gc_setup_desc': 'Der Game Center Modus nutzt zwei separate Bildschirme:',
  'guide_gc_setup_bullet_1': '📱 Dieses Tablet (Config Area) zum Einrichten',
  'guide_gc_setup_bullet_2': '📺 Ein Windows TV/PC (Game Area) zum Anzeigen',
  'guide_gc_setup_bullet_3': '🔌 Beide verbinden sich mit "amz_triball" WiFi',
  'guide_gc_setup_bullet_4': '📡 Kommunikation läuft über die Plattform',

  'guide_gc_config_title': 'Spiel konfigurieren',
  'guide_gc_config_desc': 'Von diesem Tablet kannst du:',
  'guide_gc_config_bullet_1': 'Spieltyp wählen (Wettkampf, Solo Chrono, Turnier)',
  'guide_gc_config_bullet_2': 'Spielmodus wählen (Classic, Hardcore, Champion, Combo)',
  'guide_gc_config_bullet_3': '"An Bildschirm senden" drücken um auf dem TV zu starten',

  'guide_gc_play_title': 'Während des Spiels',
  'guide_gc_play_desc': 'Spieler werfen Bälle. Punkte werden live auf dem hängenden TV angezeigt.',

  'guide_gc_troubleshoot_title': 'Problemlösung',
  'guide_gc_troubleshoot_desc': 'Bei Problemen:',
  'guide_gc_troubleshoot_bullet_1': 'Prüfen ob Plattform eingeschaltet ist',
  'guide_gc_troubleshoot_bullet_2': 'Erneut mit "amz_triball" WiFi verbinden',
  'guide_gc_troubleshoot_bullet_3': 'Game Area App auf Windows neustarten',

  'app_type': 'App-Typ',
  'edition': 'Ausgabe',

  'displaying_on_tv': 'Wird auf TV angezeigt ✓',
  ...
  'select_filter': 'Datumsfilter',
  'leaderboard_display_duration': 'Bestenlisten-Anzeigedauer',
