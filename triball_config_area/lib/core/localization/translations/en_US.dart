...
// Platform
  ...
  'guide_platform_setup_bullet_2': 'Plug Triball Platform to power',
...
// FAQ
  ...
  'no_game_area_connected': 'No game screen connected',
  'config_sent_to_game_area': 'Configuration sent to game screen',
  'game_area_count': 'Game screens connected: {count}',
  'waiting_for_game_area': 'Waiting for game screen...',

  'game_area_label': 'Game Screen',
  'checking_game_area': 'Searching for game screen...',
  'waiting_for_game_area_short': 'Waiting...',
  'utilities': 'Utilities',
  'config_area_subtitle': 'Game configurator',

  'send_to_screen': 'Send to screen',
  'sending': 'Sending...',
  'send_another': 'Send another',
  'config_sent_title': 'Configuration sent!',
  'config_sent_message': 'The game will start on the game screen.',
  'config_send_failed': 'Send failed. Check the connection.',
  'no_game_area_title': 'Screen not connected',
  'no_game_area_message': 'No game screen (TV) is connected.\n\nCheck that:\n• The Windows screen is on\n• It\'s connected to WiFi "amz_triball"\n• The Game Area app is running',
  'no_game_area_warning': 'No game screen connected. Connect the TV before sending.',

  'game_area_settings': 'Game Screen',
  'game_area_connected_count': 'Screens connected',
  'game_area_state': 'Game state',
  'current_player_label': 'Current player',
  'last_config_sent': 'Last config sent',
  'none': 'None',
  'stop_game_remote_btn': 'Stop game',
  ...
  'guide_gc_setup_title': 'Game Center Setup',
  'guide_gc_setup_desc': 'Game Center mode uses two separate screens:',
  'guide_gc_setup_bullet_1': '📱 This tablet (Config Area) to set up games',
  'guide_gc_setup_bullet_2': '📺 A Windows TV/PC screen (Game Area) to display the game',
  'guide_gc_setup_bullet_3': '🔌 Both connect to the "amz_triball" WiFi from the platform',
  'guide_gc_setup_bullet_4': '📡 Communication goes through the  platform',

  'guide_gc_config_title': 'Configure a game',
  'guide_gc_config_desc': 'From this tablet, you can:',
  'guide_gc_config_bullet_1': 'Choose match type (Competition, Solo Chrono, Tournament)',
  'guide_gc_config_bullet_2': 'Choose game mode (Classic, Hardcore, Champion, Combo)',
  'guide_gc_config_bullet_3': 'Press "Send to screen" to start the game on the TV',

  'guide_gc_play_title': 'During the game',
  'guide_gc_play_desc': 'Players throw balls at the platform. Scores display live on the suspended TV. This tablet can follow the game in real-time from settings.',

  'guide_gc_troubleshoot_title': 'Troubleshooting',
  'guide_gc_troubleshoot_desc': 'If something goes wrong:',
  'guide_gc_troubleshoot_bullet_1': 'Check that the Triball platform is powered on (green LED)',
  'guide_gc_troubleshoot_bullet_2': 'Reconnect to "amz_triball" WiFi if connection is lost',
  'guide_gc_troubleshoot_bullet_3': 'Restart the Game Area app on the Windows screen if needed',

  'app_type': 'App type',
  'edition': 'Edition',

  'displaying_on_tv': 'Displaying on TV ✓',
  ...
  'select_filter': 'Date filter',
  'leaderboard_display_duration': 'Leaderboard display duration',
